...
var params = browser.params;
    ...
    describe('To Book an Appointment for an  Existing Patient', function () {
        ...
        it('should show title of The London Clinic - Consultant Information System', function () {
            ...
            element(by.id('username')).sendKeys('c.moore-hill');
            element(by.id('password')).sendKeys('Wolf3105');
            element(by.css('body > div.container.page-login > div.row > div:nth-child(1) > div.panel.panel-default > div.panel-body > form > fieldset > div:nth-child(4) > button')).click();
            browser.waitForAngular();
            expect(browser.getTitle()).toEqual("The London Clinic - Consultant Information System");
        });

        it('should navigate to the consultant "Female" "Setterfield" appoints page', function () {
            ...
            searchFieldName.sendKeys('Setterfield');
            element(by.css('a[href*="#/ViewSessions?consultants=11&date=1431903600000"]')).click();
            ...
            var title = element(by.css('body > div > div > div > div > ng-view > h3'));
            ...
            console.log('Check for Create New Appointment');
            //expect(consultant.getText()).toEqual('Arnold, Fiona');
        });

        it('should search for Patient details', function () {
            var checkTitle = element(by.css('body > div > div > div > div > ng-view > div > div.panel > form > div:nth-child(1) > div > div.row > h3'));
            expect(checkTitle.getText()).toEqual('Check for Existing Patient');
            console.log('Check for Existing Patient' + checkTitle.getText());
            ...
            browser.waitForAngular();
            var usePatient = element(by.css('body > div > div > div > div > ng-view > div > div.panel > form > div:nth-child(1) > div > div:nth-child(3) > div.alert.alert-warning.ng-scope > div > div > div.col-md-2 > div'));
            browser.sleep(1000);
            expect(usePatient.isDisplayed()).toBe(true);
            console.log('Expect USE Patient button' + usePatient.isDisplayed());
            usePatient.click();
            browser.sleep(1000);
            //var submitBooking =  element(by.css('body > div > div > div > div > ng-view > div > div.panel > form > div:nth-child(3) > div.row > div'));
            //submitBooking.click();

        });

        it('should verify the appointment is created', function () {
            var ExstPatientDetails = element(by.css('body > div > div > div > div > ng-view > div > div.panel > form > div:nth-child(3) > div.container > div.row > h3'));
            ...
            expect(ExstPatientDetails.isDisplayed()).toBe(true);
            ...
            browser.waitForAngular();
            var successModal = element(by.css('#modalSlideUpSmall > div > div > div > div > h4'));
            expect(successModal.getText()).toEqual('Success');
        });
    });

    describe('To Book an Appointment for an Non-Existing Patient', function () {
        ...
        it('should search for Patient details', function () {
            var checkTitle = element(by.css('body > div > div > div > div > ng-view > div > div.panel > form > div:nth-child(1) > div > div.row > h3'));
            expect(checkTitle.getText()).toEqual('Check for Existing Patient');
            console.log('Check for Non-Existing Patient');
            ...
            patientFname.sendKeys('Eliza');
            patientLname.sendKeys('Dolittle');
            PatientDoB.sendKeys('31/05/1969');
            console.log('Enter search Patient details');
            browser.waitForAngular();
            var CreateNewPatient = element(by.css('body > div.page-container > div > div > div > ng-view > div > div.panel > form > div:nth-child(1) > div > div.row > div'));
            browser.sleep(1000);
            expect(CreateNewPatient.isDisplayed()).toBe(true);
            console.log('Expect CreateNewPatient button');
        ...
        it('should accept Patient Name details', function () {
            ...
            patientTitle.sendKeys('Ms');
            var patientGender = element(by.css('body > div.page-container > div > div > div > ng-view > div > div.panel > form > div:nth-child(2) > div > div:nth-child(2) > div:nth-child(3) > div.col-md-6 > div > div.radio.radio-complete > div.inline > label'));
            patientGender.click();
            ...
            console.log('Check for additionalInstruction');
            ...
            console.log('Check for Booking submission');
            //
            browser.sleep(util.winks1);
        });
